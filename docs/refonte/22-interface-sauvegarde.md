...
| Conflit | « Les deux carnets ont changé. » | Voir la comparaison ; conserver le carnet local en quittant |
...
| Quitter la comparaison | Aucune écriture locale ou distante | Carnet local intact |
...
1. Dans Safari, vérifier que l'historique montre la séance du 15.09. Si elle manque,
   arrêter le transfert et retrouver le contexte contenant le carnet.
